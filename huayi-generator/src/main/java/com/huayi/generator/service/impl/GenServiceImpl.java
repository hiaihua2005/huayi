package com.huayi.generator.service.impl;
...
import com.huayi.generator.domain.ColumnInfo;
import com.huayi.generator.domain.TableInfo;
import com.huayi.generator.mapper.GenMapper;
import com.huayi.generator.service.IGenService;
import com.huayi.generator.util.GenUtils;
import com.huayi.generator.util.VelocityInitializer;
...
public class GenServiceImpl implements IGenService
{
     ...
     */
    @Override
    public byte[] generatorCode(String tableName,String entityClassName)
    {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        ZipOutputStream zip = new ZipOutputStream(outputStream);
        // 查询表信息
        ...
        List<ColumnInfo> columns = genMapper.selectTableColumnsByName(tableName);
        // 生成代码
        generatorCode(table, entityClassName,columns, zip);
        IOUtils.closeQuietly(zip);
        return outputStream.toByteArray();
    }
    ...
    public void generatorCode(TableInfo table, List<ColumnInfo> columns, ZipOutputStream zip)
    {
        ...
        generatorCode(table,className,columns,zip);
    }
     ...
     * 生成代码
     */
    public void generatorCode(TableInfo table,String className, List<ColumnInfo> columns, ZipOutputStream zip)
    {
        // 表名转换成Java属性名
