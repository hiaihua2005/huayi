...
import com.huayi.framework.util.PropertiesUtil;
...
public class ShardedRedisPool {
    ...
    static {
        PropertiesUtil.loadPropertiesFile("redis.properties");
    }
    ...
    private static String nodeHost1 = PropertiesUtil.getProperty("redis.node1.host", "127.0.0.1");
